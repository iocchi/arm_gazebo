...
tmux send-keys -t $SESSION:3 "python gazebo_objects.py -i pg_lab.txt" C-m
tmux send-keys -t $SESSION:3 "python spawn_drawer.py" C-m
tmux send-keys -t $SESSION:3 "python spawn_pouches.py" C-m
